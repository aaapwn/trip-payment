...
- ✅ **ติ๊กว่าจ่ายแล้ว รายรายการ** - ติ๊กทีละรายการ รายการที่เพิ่มทีหลังไม่กระทบของที่ติ๊กไว้แล้ว
...
การติ๊ก "จ่ายแล้ว" เป็น**รายรายการ** (`paidShares` เก็บ `expenseKey` + คู่ from/to) ไม่ใช่รายคน
ดังนั้นจ่ายเคลียร์ของที่มีอยู่วันนี้ได้ แล้วรายการที่เพิ่มพรุ่งนี้ก็ขึ้นเป็นยอดค้างใหม่ โดยไม่แตะของที่ติ๊กไว้แล้ว

- คู่ไหนติ๊กครบทุกรายการ = "จ่ายครบแล้ว"
- ติ๊กบางรายการ = ค้างเฉพาะส่วนที่ยังไม่ติ๊ก
- ลบรายการที่ติ๊กไว้ เครื่องหมายจะถูกลบตามไปด้วย ไม่ค้างมาโผล่กับรายการใหม่
- แต่ละรายการมี `key` ของตัวเอง (client สร้าง, server เติมให้ถ้าไม่มี) เพราะตำแหน่งใน array ใช้อ้างอิงไม่ได้ —
  ลบรายการก่อนหน้าแล้ว index ทุกตัวจะเลื่อน
